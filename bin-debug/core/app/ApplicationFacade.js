...
(function (mx) {
    var ApplicationFacade = (function (_super) {
        ...
        ApplicationFacade.prototype.initializeController = function () {
            ...
            this.registerCommand(mx.SIGN_NAME.APP_FACADE_START_UP, mx.StartupCommand);
        };
        /**
        ...
        ApplicationFacade.prototype.startUp = function (rootView) {
            this.sendNotification(mx.SIGN_NAME.APP_FACADE_START_UP, rootView);
            this.removeCommand(mx.SIGN_NAME.APP_FACADE_START_UP);
        };
